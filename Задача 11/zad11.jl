function zad11(r::Robot)
    ...
    go!(r, North, steps=ras_North, go_around_barriers=true)
    putmarker!(r)
    go!(r, South, steps=ras_North, go_around_barriers=true)

    go!(r, West, steps=ras_West, go_around_barriers=true)
    putmarker!(r)
    go!(r, East, steps=ras_West, go_around_barriers=true)

    go!(r, East, steps=ras_East, go_around_barriers=true)
    putmarker!(r)
    go!(r, West, steps=ras_East, go_around_barriers=true)

    go!(r, South, steps=ras_South, go_around_barriers=true)
    putmarker!(r)
    go!(r, North, steps=ras_South, go_around_barriers=true)
end